...
if (!process.argv.includes("--allow-keyboard-control")) {
  throw new Error("Este teste também digita texto. Confirme com: npm run test:integration -- --allow-input-control --allow-keyboard-control");
}
